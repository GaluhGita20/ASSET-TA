...
{
    //
    protected $module = 'laporan-inventaris_kib-f';
    protected $routes = 'laporan.inventaris.kib-f';
    protected $views  = 'pelaporan.kib-f';
    ...
    public function __construct()
    {
        $this->prepare(
            [
                ...
                'title' => 'Laporan Aset Kontruksi Pembangunan',
                'breadcrumb' => [
