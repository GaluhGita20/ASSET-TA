...
class CoaAsetTetapController extends Controller
{
    //
    protected $module = 'master_coa_aset_lainya';
    protected $routes = 'master.coa.aset-tetap-lainya';
    ...
    public function __construct()
    {
        $this->prepare(
            [
                ...
                'title' => 'Chart of Accounts Aset Tetap Lainya',
                'breadcrumb' => [
                    'Data Master' => rut($this->routes . '.index'),
                    'Chart Of Accouts' => rut($this->routes . '.index'),
                    'COA Aset Tetap Lainya' => rut($this->routes . '.index'),
                ]
            ]
        );
    }
