                        ...
                        <div class="row row-paddingless">
                            <div class="col-12">
                                <div class="base-notification-wrapper"
                                    data-url="{{ rut('ajax.userNotification') }}"
            ...
            {{-- <div class="dropdown">
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px" aria-expanded="false">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        ...
                        @endphp
                        <img class="h-20px w-20px rounded-sm" src="{{ '/'.('assets/media/svg/flags/'.$icon) }}" alt="Image">
                    </div>
                </div>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                        ...
                        <div class="navi navi-spacer-x-0 pt-5">
                            <a href="{{ rut('setting.profile.index') }}" class="navi-item px-8 base-content--replace">
                                <div class="navi-link">
                            ...
                            <a href="{{ rut('setting.profile.notification') }}" class="navi-item px-8 base-content--replace">
                                <div class="navi-link">
                                    <div class="navi-icon mr-2">
                            ...
                            <a href="{{ rut('setting.profile.activity') }}" class="navi-item px-8 base-content--replace">
                                <div class="navi-link">
                                    <div class="navi-icon mr-2">
                                        <i class="flaticon2-rocket-1 text-danger"></i>
                                    </div>
