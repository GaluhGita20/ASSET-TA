                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control base-plugin--inputmask_currency text-right" id="valued" name="valued" oninput="updateTotal()" value="{{$record->valued}}" readonly>
                                ...
                                <div class="btn-group dropup">
                                    ...
                                    <div class="btn-group dropup">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <button type="submit" class="dropdown-item align-items-center base-form--submit-page" data-submit="1">
