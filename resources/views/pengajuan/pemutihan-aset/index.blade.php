...
@section('filters')
	<div class="row">
        ...
        <div class="col-12 col-sm-3 col-xl-3 pb-2 mr-n6">
            <input type='text' class="form-control filter-control  base-plugin--datepicker" name="submmission_date" 
                placeholder="{{ __('Tanggal Pengajuan') }}" data-post="submmission_date">
        </div>
    </div>
@endsection
