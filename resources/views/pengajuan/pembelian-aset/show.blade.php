                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 parent-group">
                                    <textarea name="note_disposisi" class="base-plugin--summernote" placeholder="{{ __('Catatan Disposisi') }}" data-height="200" disabled>{!! $record->note_disposisi  !!}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card card-custom">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 parent-group">
                                    <textarea name="sentence_end" class="base-plugin--summernote" placeholder="{{ __('Penutupan') }}" data-height="200" disabled>{!! $record->sentence_end !!}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-between">
                        ...
                        @endif
                        @if ($record->checkAction('verification', $perms))
                            @include('layouts.forms.btnBack')
                            @include('layouts.forms.btnDropdownVerification')
                            @include('layouts.forms.modalReject')
                        @endif
                    </div>
                </div>
