                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 col-form-label">
                                    <textarea name="desc_del" class="base-plugin--summernote" value="{{$record->desc_del}}" placeholder="{{ __('Alasan Penghapusan Aset') }}" data-height="200">{!! $record->desc_del  !!}</textarea>
                                </div>
                            </div>
                        </div>
                                                ...
                                                @foreach ($flows as $j => $flow)
                                                    <span class="label label-light-{{ $colors[$flow->type] }} font-weight-bold label-inline"
                                                        ...
                                                        @if($flow->role->name == 'BPKAD')
                                                            title="{{ $flow->show_type }}">Bidang Pengelolaan Aset Daerah
                                                        @else 
