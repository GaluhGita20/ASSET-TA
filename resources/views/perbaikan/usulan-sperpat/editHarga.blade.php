...
@method('POST')
                                        ...
                                        <div class="input-group">
                                            @if($record->total_cost_vendor != null)
                                                ...
                                                <input type="text" min=0 id="total_cost_vendor" name="total_cost_vendor" class="form-control base-plugin--inputmask_currency text-right"
                                                    placeholder="{{ __('Biaya Sewa Vendor') }}" value="{{$record->total_cost_vendor}}" autofocus>
                                            ...
                                            @else
                                                <input type="text" min=0 id="total_cost_vendor" name="total_cost_vendor" class="form-control base-plugin--inputmask_currency text-right"
                                                    placeholder="{{ __('Biaya Sewa Vendor') }}" value="0" autofocus>
                                                <div class="input-group-append">
                                                    <span class="input-group-text" >
                                                        Rupiah
                                                    </span>
    ...
    <div class="row mb-3">
        <div class="col-sm-12">
            <div class="card card-custom">
                @if (request()->route()->getName() == $routes.'.editHarga')
                <div class="card-footer">
                    <div class="d-flex justify-content-between">
                        @include('layouts.forms.btnBack')
                        <p> Pastikan Data Harga Jasa Vendor Diisi
                        </p>
                        <div class="btn-group dropdown">
                            <button type="submit" class="btn btn-success align-items-center base-form--submit-page">
