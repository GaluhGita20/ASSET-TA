                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 col-form-label">
                                    <input type="text" class="form-control" name ="sperpat_name" value="{{$detail->sperpat_name}}" placeholder="{{__('Nama Sperpat')}}">
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 col-form-label">
                                    <textarea name="desc_sper" class="base-plugin--summernote" value="{{$detail->desc_sper}}"  placeholder="{{ __('Keterangan Spesifikasi Sperpat') }}" data-height="200">{!! $detail->desc_sper  !!}</textarea>
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 col-form-label">
                                    <input type="number" class="form-control" id="qty" name="qty" value="{{$detail->qty}}"  placeholder="{{ __('Jumlah Sperpat') }}" min="1"  oninput="updateTotal()">
                                </div>
                            </div>
                        </div>
