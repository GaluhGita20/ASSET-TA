            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">{{ __('Hasil Pemeriksaan Awal') }}</label>
                                <div class="col-sm-10 col-form-label">
                                    @if(!empty($record->check_up_result))
                                        <textarea name="check_up_result" value="{{$record->check_up_result}}" class="base-plugin--summernote"  placeholder="{{ __('Tindakan Dilakukan') }}" data-height="200" disabled>{!! $record->check_up_result  !!}</textarea>
                                    @else
                                        <textarea name="check_up_result" class="base-plugin--summernote"  placeholder="{{ __('Tindakan Dilakukan') }}" data-height="200" disabled> </textarea>
                                    @endif
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-10 col-form-label">
                                    ...
                                    {{-- @else
                                        <select name="repair_results" class="form-control" disabled>
                                            <option value="yes" {{ $record->is_disposisi == "yes" ? 'selected':'' }}>{{ __('S') }}</option>
                                            <option value="no" {{ $record->is_disposisi == "no" ? 'selected':'' }}>{{ __('BELUM SELESAI') }}</option>
                                        </select>
                                    @endif --}}
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">{{ __('Tindakan Perbaikan') }}<span style=" color: red;margin-left: 5px;">*</span></label>
                                <div class="col-sm-10 col-form-label">
                                    @if(!empty($record->repair_date))
                        ...
                        <div class="col-sm-12">
                            <div class="form-group row">  
                                <label class="col-md-2 col-form-label">{{ __('Penanggung Jawab Perbaikan') }}<span style=" color: red;margin-left: 5px;">*</span></label>
        ...
        <div class="row mb-3">
            <div class="col-sm-12">
                <div class="card card-custom">
                    ...
                    <div class="card-body p-8">
                        {{-- @include('perbaikan.trans-sperpat.detail.index') --}}
                        @include('perbaikan.pj-perbaikan.detail.index')
                    </div>
                </div>
            </div>
        </div>
