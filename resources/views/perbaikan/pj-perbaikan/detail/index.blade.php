            ...
            <td>
                <div class="row">
                    <div class="col-12 col-sm-6 col-xl-3 pb-2">
                        <input type="text" class="form-control filter-control" data-post="sperpat_name"
                            placeholder="{{ __('Nama Sperpat') }}">
                    </div>
                </div>
            </td>
        </tr>
...
<div class="alert alert-custom alert-light-primary fade show py-4" role="alert">
    ...
    <div class="alert-text text-primary">
        ...
        <div class="mb-10px" style="white-space: pre-wrap;">Sebelum Melakukan Update Hasil Perbaikan Pastikan Semua  Transaksi Pembelian Sperpat Sudah Selesai Dilakukan (Status : Completed)</div>
    </div>
</div>
