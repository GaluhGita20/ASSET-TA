...
@section('modal-body')
    ...
    <input type="hidden" name="pemeliharaan_id" value="{{ $detail->id }}">
    <div class="row">
        ...
        <div class="col-sm-12 col-sm-12">
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-7 parent-group">
                    <textarea class="form-control" name="first_condition" value = "{{ $detail->first_condition }}" placeholder="{{ __('Kondisi Awal Aset') }}" disabled>{{ $detail->first_condition }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-sm-12">
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-7 parent-group">
                    <textarea class="form-control" name="latest_condition" value="{{ $detail->latest_condition }}" placeholder="{{ __('Kondisi Setelah Pemeliharaan Aset') }}" disabled>{{ $detail->latest_condition }} </textarea>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-7 parent-group">
                    <textarea class="form-control" name="maintenance_action" value="{{ $detail->maintenance_action }}" placeholder="{{ __('Tindakan Pemeliharaan Dilakukan') }}" disabled>{{ $detail->maintenance_action }}</textarea>
                </div>
            </div>
        </div>
