                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <input class="form-control base-plugin--datepicker" name="spk_start_date" value="{{$record->spk_start_date}}" placeholder="{{ __('Tanggal Mulai Kontrak') }}" data-date-end-date="{{ now()}}" readonly >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <input class="form-control base-plugin--datepicker" name="spk_end_date" value="{{ $record->spk_end_date}}" placeholder="{{ __('Tanggal Selesai Kontrak') }}" readonly>
                                </div>
                            </div>
                        </div>
