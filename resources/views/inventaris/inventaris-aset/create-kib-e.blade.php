                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="col-10 parent-group">
                               ...
                               <input type="hidden" id="type" name="type" value="KIB E">
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <input type="text" class="form-control" name="creators" placeholder="{{ __('Pencipta') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <input type="text" class="form-control" name="title" placeholder="{{ __('Judul') }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <div class="input-group">
                                        <input type="number" step="0.1" class="form-control base-plugin--inputmask_currency text-right" placeholder="{{ __('Ukuran Hewan') }}" name="size_animal">
