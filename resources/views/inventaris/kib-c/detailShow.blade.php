                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                <div class="col-4 pr-0">
                                    <label class="col-form-label">{{ __('Luas Lantai') }}</label>
                                </div>
                                <div class="col-8 parent-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control base-plugin--inputmask_currency text-right" name="wide" placeholder="{{ __('Luas Lantai') }}" value="{{ $record->wide }}" readonly>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control base-plugin--inputmask_currency text-right" name="wide_bld" placeholder="{{ __('Luas Bangunan') }}" value="{{ $record->wide_bld }}" readonly>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                M2
                                            </span>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    <input class="form-control " name="no_sertificate" placeholder="{{ __('Nomor Document') }}" value="{{ $record->no_sertificate }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    ...
                                    placeholder="{{ __('Tanggal Document') }}"  data-date-end-date="{{ now() }}" value="{{ $record->sertificate_date }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-8 parent-group">
                                    ...
                                    placeholder="{{ __('Status Tanah') }}" value="{{ $record->land_status }}" readonly>
                                </div>
                            </div>
                        </div>
