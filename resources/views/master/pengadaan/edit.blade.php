...
@section('modal-body')
	...
	<div class="form-group row">
        <label class="col-sm-12 col-md-4 col-form-label">{{ __('Jenis Pengadaan') }}<span style=" color: red;margin-left: 5px;">*</span></label>
        <div class="col-sm-12 col-md-8 parent-group">
            <input type="text" name="name" class="form-control" placeholder="{{ __('Jenis Pengadaan') }}" value="{{ $record->name }}">
        </div>
    </div>
    <div class="form-group row">
