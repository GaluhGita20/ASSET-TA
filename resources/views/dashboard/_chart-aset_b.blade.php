<div class="col-md-6">
	<div class="card card-custom card-stretch gutter-b chart-pelaporan2-wrapper">
		<div class="card-header h-auto py-3">
			<div class="card-title">
				<h3 class="card-label">
					<span class="d-block text-dark font-weight-bolder">{{ __('Peralatan Mesin') }}</span>
				</h3>
			</div>
			<div class="card-toolbar" style="max-width: 500px;">
				<form id="filter-chart-pelaporan2"
					action="{{ route($routes.'.chartAsetKIBB') }}"
					class="form-inline"
					role="form">
...
@push('scripts')
	<script>
		$(function() {
		    iniFilterchartTermind();
		    drawchartTermind();
		});

		var iniFilterchartTermind = function () {
		...
		var drawchartTermind = function () {
			var filter = $('#filter-chart-pelaporan2');
		...
		var renderchartTermind = function (options = {}) {
			var element = document.getElementById('chart-pelaporan2');
