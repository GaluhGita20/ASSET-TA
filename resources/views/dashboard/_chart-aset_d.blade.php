<div class="col-md-6">
	<div class="card card-custom card-stretch gutter-b chart-pelaporan5-wrapper">
...
@push('scripts')
	<script>
		$(function() {
		    iniFilterchartTermink();
		    drawchartTermink();
		});

		var iniFilterchartTermink = function () {
